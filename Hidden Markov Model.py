...
#data = pd.read_csv('https://bit.ly/2NAt14E')
data = pd.read_csv('dataHarianAktivitas.csv')
...
a, b = baum_welch(V, a, b, initial_distribution, n_iter=200)
